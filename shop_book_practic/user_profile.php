        ...
        <div class="container ">
            <div class="user-profile">
                ...
                <div class="user-profile-table">
                    ...
                    <!-- <div>
                        <div class='ur30_black'>История оплаты:</div>
                        <table>
                            <tr>
                                <th class='ub22_black'>Номер карты</th>
                                <th class='ub22_black'>Дата оплаты</th>
                                <th class='ub22_black'>Тип подписки</th>
                                <th class='ub22_black'>Стоимость</th>
                            </tr>
                                <?php
                                    // $myDB->paymet_info($id);
                                ?>
